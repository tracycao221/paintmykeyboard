...
export const metadata: Metadata = {
  title: `${siteConfig.gameName} Trello ({Month} {Year}) - Discord & Wiki Status`,
  description: `Check ${siteConfig.gameName} Trello, Discord, wiki, official links, and Roblox source status for {Month} {Year}.`,
  alternates: { canonical: `${siteConfig.domain}/trello` },
  openGraph: {
    title: `${siteConfig.gameName} Trello ({Month} {Year})`,
    description: `Check ${siteConfig.gameName} Trello, Discord, wiki, official links, and Roblox source status for {Month} {Year}.`,
